...
const PMTooltipContent = React.forwardRef<
...
PMTooltipContent.displayName = TooltipPrimitive.Content.displayName;
...
const PMTooltip = ({ content, children, side = "top" }: PMTooltipProps) => (
  <TooltipProvider>
    <Tooltip>
      <TooltipTrigger asChild>{children}</TooltipTrigger>
      <PMTooltipContent side={side}>{content}</PMTooltipContent>
    </Tooltip>
  </TooltipProvider>
);
